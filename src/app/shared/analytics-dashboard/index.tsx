...
import StatGrid from '@/app/shared/analytics-dashboard/file-stats'
import BrushBarChart from '@/app/shared/analytics-dashboard/brush-bar-chart';
  ...
  return (
    <div className="@container">
      <div className="grid grid-cols-1 gap-6 @4xl:grid-cols-2 @7xl:grid-cols-12 3xl:gap-8">
        ...
        <StatGrid className="grid-cols-1 @xl:grid-cols-2 @4xl:col-span-2 @6xl:grid-cols-4 @7xl:col-span-12" />
